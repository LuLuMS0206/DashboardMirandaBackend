...
var RoomService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, roomModel_1.RoomModel.find().exec()];
    ...
    RoomService.fetchOne = function (roomId) {
        return __awaiter(this, void 0, void 0, function () {
            var room, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, roomModel_1.RoomModel.findOne({ _id: roomId }).exec()];
                    case 1:
                        room = _a.sent();
                        if (!room)
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        room = new roomModel_1.RoomModel(newRoom);
    ...
    RoomService.removeRoom = function (roomId) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, roomModel_1.RoomModel.findByIdAndDelete(roomId).exec()];
                    case 1:
                        result = _a.sent();
                        if (!result)
                            throw new APIError_1.APIError('Room not found', 404, true);
    ...
    RoomService.modifyRoom = function (modifiedRoom) {
        return __awaiter(this, void 0, void 0, function () {
            var room, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, roomModel_1.RoomModel.findByIdAndUpdate(modifiedRoom._id, modifiedRoom, { new: true }).exec()];
                    case 1:
                        room = _a.sent();
                        if (!room)
                            throw new APIError_1.APIError('Room not found', 404, true);
    ...
    RoomService.searchRooms = function (searchTerm) {
        return __awaiter(this, void 0, void 0, function () {
            var error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
