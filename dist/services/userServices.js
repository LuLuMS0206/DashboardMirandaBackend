...
var UserService = /** @class */ (function () {
    ...
    UserService.fetchOne = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var user, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UserService.fetchByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var user, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UserService.removeUser = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, userModel_1.UserModel.findByIdAndDelete(userId).exec()];
                    case 1:
                        result = _a.sent();
                        if (!result)
                            throw new APIError_1.APIError('User not found', 404, true);
    ...
    UserService.modifyUser = function (modifiedUser) {
        return __awaiter(this, void 0, void 0, function () {
            var user, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, userModel_1.UserModel.findByIdAndUpdate(modifiedUser._id, modifiedUser, { new: true }).exec()];
                    case 1:
                        user = _a.sent();
                        if (!user)
                            throw new APIError_1.APIError('User not found', 404, true);
    ...
    UserService.authenticate = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var user, isMatch, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_7 = _a.sent();
                        throw new APIError_1.APIError(error_7.message, 500, false);
